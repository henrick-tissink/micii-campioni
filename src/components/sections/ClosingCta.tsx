...
// =============================================================================
// Home-only closing CTA (hardcoded per design handoff). The shared, prop-driven
// `CTASection` remains the reusable closing band for inner pages.
// =============================================================================
      ...
      <Container className="relative">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_auto] lg:gap-14">
          ...
          <div className="min-w-[320px] rounded-3xl border border-white/[0.18] bg-black/[0.18] p-8 backdrop-blur-md">
            ...
            <a href={`mailto:${EMAIL}`} className="mt-2 block text-sm text-white/85 no-underline">
              {EMAIL}
            </a>
